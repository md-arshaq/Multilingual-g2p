#!/usr/bin/env python3
"""
Regenerate tts_vits_training.ipynb as a fully self-contained, robust,
Run-All-ready Colab notebook for training Baseline and Clustered VITS models.
"""
import json
...
code([
    ...
    "\n",
    "# Fix cuDNN status internal error on T4 GPUs by enforcing native CUDA conv1d kernels\n",
    "torch.backends.cudnn.enabled = False\n",
    "if not hasattr(torch.nn.functional, '_orig_conv1d'):\n",
...
code([
    ...
    "# ============================================================\n",
    "!pip install -q coqui-tts \"transformers<5.0.0\"\n",
])

# CELL 3 - Mount + Extract
code([
    "# ============================================================\n",
    ...
    "elif os.path.exists(drive_data_folder):\n",
    "    print(f'Zip not found, using unzipped Drive folder: {drive_data_folder}')\n",
...
code([
    ...
    "    torch.nn.functional.conv1d = safe_conv1d\n",
    "\n",
    "print('Tokenizer patcher & helper utilities ready.')\n",
])
...
out = 'notebooks/tts_vits_training.ipynb'
